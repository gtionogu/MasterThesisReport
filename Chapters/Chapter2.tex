...
In recent years, botnets have become one of the major threats to information security because they have been constantly evolving in both size and sophistication.\\

%http://dimva2014.isg.rhul.ac.uk/slides/phoenix-talk.pdf
Bornets have become A largely widespread and highly lucrative criminal activity.(Flashback(600k compromised targets), Grum(840k compromised devices, 40B spam emails/month), TDL-4(4,5M victims in first 3 months), Gameover ZeuS(1M infections, required a lot of collaboration to take down)\\
...
\subsection{Botnet purpose and actions/attacks}
...
% Therefore, understanding the botnet life cycle and their architecture may yield to better detection mechanisms.

\subsection{Botnets Lifecycle}
...
\subsubsection{Issues with the channel}
...
\section{Possible approaches to provide better features}
