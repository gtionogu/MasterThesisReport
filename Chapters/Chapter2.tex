...
\paragraph{What is a bot?} Bots are small programs allowing to remotely control and perform commands on computers. They are the foundation of botnets. 
...
\paragraph{What is the goal of an attacker} This paper presented by the SANS institute considers two types of bots. Bots used to perpetuate attacks, bots used for their content and both.

%/!\ The value of information on a personal computer is often overlooked. There are many applications for home use, like tax preparation software, that store volumes of key personal and financial information. Browsers can cache website and account information. Email clients store contact information. Many home computers have sensitive work information on them, exposing a company's intellectual property to potential disclosure /!\


- 2 types of bots
- target compromised to extend botnet, target compromised for its data or both
= the attacker is after the valuable information on the compute, the storage, processing, and communication capabilities of the computer, or both
- Personal information on home applications(ex: tax preparation software stores volumes of key personal and financial information. Browsers can cache website and account information. Email clients store contact information) overlooked + valuable sensitive work information on home pc -> exposing company (potential intellectual property disclosure). These are examples or valuable information that can be extracted and sold. 
...
vulnerability on the victim's host.(25) Then the binary of the bot is downloaded onto the host. To find
this binary a DNS lookup has to be done. Which can't be avoided but can be hidden.(26) This is the most dominant behavior throughout all botnets(16)\\
