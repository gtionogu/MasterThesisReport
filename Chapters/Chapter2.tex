...
DNS stands for Domain Network System which main purpose is to provide the IP address of a domain name (i.e. google.com).\\
...
\paragraph{Protocol example} to understand later where the malicious actors abuse the protocol.\\
\cite{dns2}
...
\paragraph{Structure of the DNS packets?} To understand how the protocol is exploited we need to dive into the specifics of the packets structure.
...
%%%%%%%%%%%
%The question and Answer sections have the most interesting information but the header also contains flags that are abused: 
