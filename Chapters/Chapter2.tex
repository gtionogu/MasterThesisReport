...
As explained in the "abuse" section of the DNS chapter, a new type of detection techniques have been studied that aim at finding bots evading the more usual detection techniques using the DNS protocol, which is what we aim to further study and hopefully improve the current solutions.
