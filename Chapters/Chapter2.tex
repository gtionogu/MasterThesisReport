...
There are 5 steps in the machine learning workflow\cite{ml-worflow}: 
The Machine learning workflow starts by obtaining the dataset that will be used to learn and create the model. The model dataset will be divided into multiple sets: the training set and the testing set. The training set will be used initially by the algorithm to learn and the testing set will be used to contrast the accuracy of the learning and create a feedback loop. 
