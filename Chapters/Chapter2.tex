...
Features 1 to 4 have been left out because couldn't nd a datasets
long in time enough to put in practice these features. Furthermore,
the CIC is a compilation of dierent labelled datasets which is equivalent
of not having timestamps.

There is also a possibilitiy to analyze the DNS queries and not only the answers to uncovers techniques such as tunneling.
