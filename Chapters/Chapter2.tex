...
\paragraph{What are the metrics used to assess these topologies?}
...
Latency: Reliability in message transmission
Enumeration: An ability to accurately estimate a botnet size
Difficulty for security analysis
Re-sale: A possibility to carve off sections of the botnet for lease or resale to
other operators. 
