...
In this section, we are going to present the classifications of botnets and what part of the research we have decided to focus on.\\
We will start by presenting the taxonomy of botnets and their detection, then explain the current state of the art regarding botnet detection and finally summarize the research on the detection methods we focus on.
