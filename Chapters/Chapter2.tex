...
We will start by presenting the taxonomy of botnets, then explain the current state of the art regarding botnet detection and finally summarize the research on the detection methods we focus on.
