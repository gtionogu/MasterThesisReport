...
\\
The common features presented by  \cite{honeynet}\cite{ff2}\cite{ff3}\cite{ff_botconf} bring forward the main features to detect fast-fluxing, the next papers had additional features to improve detection specifically of malicious fast-fluxing. 
