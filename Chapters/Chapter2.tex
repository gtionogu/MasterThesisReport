...
With DNS tunneling, another protocol can be tunneled through DNS. A DNS tunnel can be used for CnC data exfiltration or tunneling of
any internet protocol (IP) traffic.
...
\subparagraph{Feature selection} After you have extracted the features from the raw data there is a very important step to go through. The number of features used can be a major impact of your research in regards to redundancy, complexity. Therefore, the next step is to decide which features we want to use for our experiment.
