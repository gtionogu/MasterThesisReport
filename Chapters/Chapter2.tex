...
%memoire
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
For IP flux, most papers have similar features they propose to detect fast-flux but with different settings for their experiments. The big challenge for our thesis was to find the features that allowed us to find differences betweent malicious fast-flux networks(FFSN) and content delivery networks(CDNs). Both use fast-flux for different reasons making it hard to differentiate.\\
\\
The features most papers \cite{honeynet}\cite{ff2}\cite{ff3}\cite{ff_botconf} bring forward are based
TODO: explain the idea behind the features
